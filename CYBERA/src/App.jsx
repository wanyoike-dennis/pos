...
export default function PosApp() {
  ...
  return (
    <div className={`transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-100 text-gray-900'} min-h-screen p-6 font-sans`}>
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md">
          ...
          <div className="space-y-3">
            ...
            <button onClick={addProduct} className="btn-blue">
      ...
      {/* Category Summary */}
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md mt-6 max-w-lg mx-auto">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Sales Summary by Category</h3>
        <ul className="space-y-2 text-sm">
          {Object.entries(categoryTotals).map(([cat, amount]) => (
            <li key={cat} className="flex justify-between border-b border-gray-200 dark:border-gray-600 pb-1">
              <span>{cat}</span>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md text-center mt-6">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4 mt-4">
          <button
            ...
            className="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded-lg font-medium flex items-center gap-2"
          >
        ...
        {showPreview && (
          <div className="mt-6 p-6 border rounded-lg bg-white dark:bg-gray-800 text-gray-800 dark:text-white max-w-lg mx-auto shadow-xl">
...
// You can also use a global CSS file to define these:
// .input { border, padding, rounded, focus styles }
// .btn-blue { bg-blue-600, hover, text-white, padding, rounded, flex gap }
